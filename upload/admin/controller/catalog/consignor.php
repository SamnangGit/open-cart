...
class Consignor extends \Opencart\System\Engine\Controller
{
	...
	public function index(): void
	{
		...
		$this->response->setOutput($this->load->view('catalog/Consignor', $data));
	}
	...
	protected function getList(): string
	{
		...
		$data['sort_vendor'] = $this->url->link('catalog/Consignor.list', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.vendor' . $url);
		...
		return $this->load->view('catalog/Consignor_list', $data);
	}
	...
	public function save(): void
	{
		...
		if (!$this->user->hasPermission('modify', 'catalog/Consignor')) {
